    ...
    sample_resume = {
        ...
        "projects": [
            ...
            },
            {
                ...
                "description": "Created a weather forecasting application"
            }
        ],
        "experience": [
            {
        ...
        "skills": ["Python", "JavaScript", "React", "Node.js", "MongoDB", "MySQL"]
    }
    
    # Generate questions
    questions = generate_interview_questions(sample_resume)
